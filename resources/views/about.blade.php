...
<section id="about-us" style="padding: 40px;">
  ...
  <!-- BGF STRUCTURE SECTION -->
<section class="info-section">

    <div class="bgf-structure">
        ...
        <div class="bgf-block">
            ...
            <p>
                BGF is a forestry implementation platform enabling partners, investors,
                and institutions to design, fund, and execute large-scale forestry
                programmes in dryland environments.
            </p>
        </div>
        ...
        <div class="bgf-block">
            ...
            <p>
                BGF acts as an independent execution partner within structured forestry
                programmes, managing implementation, operations, reporting,
                and long-term field stewardship.
            </p>
        </div>
        ...
        <div class="bgf-block">
            ...
            <p>
                Our model separates ownership, financing, and execution,
                ensuring transparency, governance clarity, and long-term
        ...
        <div class="experience-image-container">
            <img src="{{ asset('images/spray.jpg') }}" 
    ...
    <div id="Experience">
        <h2 class="small-heading">Our Experience</h2>
        <p>
    ...
    <div>
        <h2 class="small-heading">Institutional Evolution</h2>
        <p>
   ...
   <div style="margin-top: 40px; text-align: center;">
    <h2 class="small-heading">Who We Work With</h2>
...
<div class="institution-image-container">
    ...
    <div class="about-relationship-section">
        <h2 class="small-heading">Relationship with the Foundation</h2>
        <p>
    ...
    <div id="Vision">
        ...
        <p>
            To contribute to the transformation of dryland landscapes into productive and resilient ecosystems.
        </p>
    </div>

    <div>
        <h2 class="small-heading">Mission</h2>
        <p>
            To design, implement, and manage sustainable forestry and agroforestry programmes in collaboration with partners, communities, and investors.
        </p>
    </div>

<div class="institution-image-container">
            <img src="{{ asset('images/DSC.jpg') }}" 
                 alt="Institutional Evolution Image" 
                 class="institution-image">
        </div>
    ...
    <div class="diagram">
        ...
        <div class="row">
            ...
            <div class="box">
                BGFF - Public Interest Layer
                <br>
                <small>(Foundation / Donor Programmes)</small>
            </div>
        </div>
        ...
        <div class="row split">
            ...
            <div class="branch">
                ...
                <div class="diagram-arrow small-arrow">↓</div>
            ...
            <div class="branch">
                ...
                <div class="box">
                    Participation Layer
                    <br>
                    <small>(Farmers & Land Stewardship)</small>
                </div>
